...
* Recommender System
* Unsupervised Learning Techniques or Generative Models (debating if I should focus on this)
* Reinforcement Learning (debating If I should focus on this)
...
Top-down teaching approach by Jeremy Howard and Rachel Thomas. Specifically, I want to focus on the ones that use Keras (not Pytorch).
...
Andrew Ng is just so good at explaining these concepts using intuition and very basic examples. The teaching style is Bottom-up.
...
#### [Stanford CS 231N: Convolutional Neural Network](http://cs231n.stanford.edu/syllabus.html)

This is highly recommended by Jiaying and Heerad. This course honestly is probably the most rigorous course of the three mentioned here because it's an actual Stanford Course. I was told the Homeworks are superb and I should definitely do them. This is hands down my favorite course!
...
#### [Stanford CS 224N: NLP with Deep Learning](http://web.stanford.edu/class/cs224n/archive/WWW_1617/syllabus.html)

This is one of the other pillar class for DL at Stanford, focusing on NLP. I originally didn't intend to study this, but I am using it to complement details didn't covered in the Coursera C5 on Word Embeddng, RNN, and Sequence Models. Lecture with asterisk are the more important.
...
This is hands down the best book for a good introduction to Keras, one of the best libraries out there for doing practical DL. I kind of accept the fact that libraries are still in competition, and there is currently no best one to pick from. I like the API design, so this is my go to book.
...
This is a very good resource for learning tensorflow. Honestly, I feel like learning tensorflow is a pain. The mental model of first defining the computational graph, then feed data into the computational graph for learning is just not that intuitive to me. The Estimator APIs and Eager mode helps to a certain extent, but I still don't like it as much as Keras. I am not going to invest too much time learning this for now (will focus on Keras and applications instead).
...
* [Lecture 4](https://docs.google.com/document/d/1tLThJGHyMICyXwSIxyZ4D4cZ1hJ1Iuk8WFxe7gBBKa4/edit): Eager Execution
* [Lecture 5](https://docs.google.com/document/d/1wqp8_-H06oE4zB9CHDwzTx5BfAOMM_6nnNJMSfkazkU/edit): Variable scope and name space (somewhat confusing)
